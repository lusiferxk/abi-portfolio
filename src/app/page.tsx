...
const socialLinks = [
  {
    name: "Facebook",
    handle: "abi.amandi200278",
    url: "https://www.facebook.com/abi.amandi200278",
    icon: (
  ...
  },
  {
    name: "Instagram",
    handle: "@abi.amandi",
    url: "https://www.instagram.com/abi.amandi/",
    icon: (
      <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24">
  ...
  },
  {
    name: "LinkedIn",
    handle: "abi-amandi",
    url: "https://www.linkedin.com/in/abi-amandi-1877391b0/",
    icon: (
      <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24">
      ...
      >
        ...
        <div className="w-full px-6 sm:px-10 md:px-16 py-8 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs font-mono-tech text-zinc-400 bg-white relative z-10">
          ...
          <div className="flex items-center gap-5 text-xs font-mono-tech">
            <a
              href="https://www.facebook.com/abi.amandi200278"
              target="_blank"
              rel="noopener noreferrer"
              className="text-zinc-500 hover:text-zinc-950 transition-colors uppercase tracking-wider"
            >
              Facebook
            </a>
            <span className="text-zinc-300">•</span>
            <a
              href="https://www.instagram.com/abi.amandi/"
              target="_blank"
              rel="noopener noreferrer"
              className="text-zinc-500 hover:text-zinc-950 transition-colors uppercase tracking-wider"
            >
            ...
            <span className="text-zinc-300">•</span>
            <a
              href="https://www.linkedin.com/in/abi-amandi-1877391b0/"
              target="_blank"
              rel="noopener noreferrer"
              className="text-zinc-500 hover:text-zinc-950 transition-colors uppercase tracking-wider"
            >
